...
# # Streamlit app title
# st.title("Real-Time Person Detection with YOLO")
...
#         # with col2:
#         header_placeholder2.caption("Cam 2: Local Image")
...
#         header_placeholder3.caption("Cam 3: Local Image")
#         video_placeholder3.image(local_image_path, use_container_width=False,width=400)
#         header_placeholder4.caption("Cam 4: Local Image")
